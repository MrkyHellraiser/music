...
<template>
    ...
    <vee-form :validation-schema="schema" @submit="register"
        ...
        <!-- Confirm Password -->
        <div class="mb-3">
            <label class="inline-block mb-2">Confirm
                Password</label>
        ...
        <div class="mb-3 pl-6">
            ...
            <label class="inline-block">Accept terms of
                service</label>
...
let reg_alert_variant = ref("bg-blue-500");
let reg_alert_msg = ref("Please wait! Your account is being created.");
